...
class Administrative(commands.GroupCog, group_name="admin"):
    ...
    async def extensions(self, interaction: Interaction):
        """
        List Riddler's enabled extensions.
        """
    ...
    async def restart(self, interaction: Interaction):
        """
        Shut down Riddler. If the bot is running in a supervisor, this should restart the process.
        """
